                                                ...
                                                <div class="panel-body p-20">
                                                    <form class="form-horizontal" method="post">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-6">
                                                               <a class ="btn btn-success" href="find-result.php">click here</a>
                                                            </div>
                                                        </div>
                                        ...
                                        <div class="col-md-11">
                                            <div class="panel">
                                                ...
                                                <div class="panel-body p-20">
                                                    ...
                                                    <form class="form-horizontal" method="post">
                                                        <div class="form-group">
                                                            <label for="inputEmail3" class="col-sm-6 control-label">Search your Exame</label>
                                                            <div class="col-sm-6">
                                                               <a class ="btn btn-success" href="find-exam.php">click here</a>
                                                            </div>
                                                        </div>
