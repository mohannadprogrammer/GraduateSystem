...
function calcreditPoint($dgree , $credit)
{
    $grade =getGradePoints($dgree);
    return $grade *$credit;
}

function GPA($totalcreditPoint , $totalHours)
{
    return round($totalcreditPoint /$totalHours,2);
}
                                            ...
                                            <div class="panel-body p-20">
                                                ...
                                                <thead>
                                                        <tr style="text-align: center">
                                                            ...
                                                            <th style="text-align: center">Sub GPA</th>
                                                        </tr>
                                               </thead>
...
// Code for result
 ...
 $query ="select t.StudentName,t.RollId,t.ClassId,t.marks,SubjectId,tblsubjects.SubjectName ,tblsubjects.houres from (select sts.StudentName,sts.RollId,sts.ClassId,tr.marks,SubjectId from tblstudents as sts join  tblresult as tr on tr.StudentId=sts.StudentId) as t join tblsubjects on tblsubjects.id=t.SubjectId where (t.RollId=:rollid and t.ClassId=:classid)";
...
<td style="text-align: center"><?php echo htmlentities(getGrade($totalmarks=$result->marks));?></td>
<td style="text-align: center"><?php echo htmlentities(round(getGradePoints(getGrade($result->marks))/$result->houres),2);?></td>

                                                		</tr>
<?php 
$totlcount+=$totalmarks;
$totHours +=$result->houres;
$totlgradePoints +=calcreditPoint(getGrade($totalmarks=$result->marks),$result->houres);
$cnt++;}
?>
<!-- <tr>
...
<td style="text-align: center"><b><?php echo GPA($totlgradePoints,$totHours); ?></td>
                                                        </tr>
<!-- <tr>
