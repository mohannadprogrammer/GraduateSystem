<div class="left-sidebar bg-black-300 box-shadow ">
                        <div class="sidebar-content">
                            <div class="user-info closed">
                                <img src="http://placehold.it/90/c2c2c2?text=User"  class="img-circle profile-img">
                                <?php session_start(); 
                                echo "<h6 class='title'>".$_SESSION['alogin']."</h6>";
                                ?>
                                <small class="info">Admin User</small>
                            </div>
                            <!-- /.user-info -->
                            ...
                            <div class="sidebar-nav">
                                <ul class="side-nav color-gray">
                                    ...
                                    <li>
                                        <a href="#"><i class="fa fa-user"></i> <span>Admin User</span> </a>
  ...
  <li class="has-children">
   ...
   <li class="has-children">
                                    ...
                                    <li class="has-children">
                                        <a href="#"><i class="fa fa-info-circle"></i> <span>Exame</span> <i class="fa fa-angle-right arrow"></i></a>
                                        <ul class="child-nav">
                                            <li><a href="add-exam.php?q=4"><i class="fa fa-bars"></i> <span>Add Exame</span></a></li>
                                            <li><a href="manage-exame.php"><i class="fa fa fa-server"></i> <span>Manage Exame</span></a></li>
