...
$sql="INSERT INTO  tblsubjects(SubjectName,SubjectCode,houres) VALUES(:subjectname,:subjectcode,:credit)";
...
<div class="alert alert-success left-icon-alert" role="alert">
 ...
 <input type="text" name="subjectname" class="form-control" id="default" placeholder="Subject Name" required="required">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-10">
 <input type="text" name="credit" class="form-control" id="default" placeholder="Credit houres" required="required">
                                                        </div>
                                                    </div>
