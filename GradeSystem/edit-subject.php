...
$sql="update  tblsubjects set SubjectName=:subjectname,SubjectCode=:subjectcode ,houres=:credit where id=:sid";
...
{   ?>                                               
 ...
 <input type="text" name="subjectname" value="<?php echo htmlentities($result->SubjectName);?>" class="form-control" id="default" placeholder="Subject Name" required="required">
                                                    ...
                                                    <div class="form-group">
                                                        <label for="default" class="col-sm-2 control-label">Credit houres</label>
                                                        <div class="col-sm-10">
 <input type="text" name="credit" class="form-control"  value="<?php echo htmlentities($result->houres);?>" id="default" placeholder="Credit houres" required="required">
                                                        </div>
                                                    </div>
<div class="form-group">
