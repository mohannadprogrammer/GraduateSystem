                    ...
                    <div class="col-md-4 col-md-offset-4">
                        <div class="panel login-box">
                            ...
                            <div class="panel-body p-20">
                                ...
                                <form action="exame.php" method="get">
                                    ...
                                    <div class="form-group">
                                		<label for="rollid">Enter exame title</label>
                                        <input type="text" class="form-control" id="title" placeholder="Enter exame title" autocomplete="off" name="title">
                                	</div>
                                    <div class="form-group">
